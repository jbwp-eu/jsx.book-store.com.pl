...
Sklep internetowy z książkami: katalog, koszyk, checkout, płatności Stripe / PayPal oraz panel admina. Monorepo z REST API (Express + JavaScript) i SPA React (JSX).
